#!/usr/bin/env python3
"""
Module implementing an LRU (Least Recently Used) Caching strategy.
"""
...
class LRUCache(BaseCaching):
    """
    Implementation of LRU (Least Recently Used) Caching.
    ...
    def put(self, key, item):
        ...
        if key and item:
            ...
            if len(self.cache_data) > BaseCaching.MAX_ITEMS:
                removed_key = self.cache_data_list.pop(0)
